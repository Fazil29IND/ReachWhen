    ...
    <body>
        ...
        <script>
            function predict() {
                ...
                const deptTime =
                    document.getElementById('deptTime').value;
                        ...
                        document.getElementById('result').innerHTML = `
                            ...
                            >
                                ...
                                <p>
                                    ...
                                    ${data.actual_duration} minutes
                                </p>

                                <p>
                                    <strong>Predicted Duration:</strong>

                                    ${data.predicted_duration.toFixed(2)}
                                    minutes
                                </p>
...
def predict():
    ...
    try:
        ...
        if actual_duration > 0:
            ...
            percentage_error = (
                absolute_error / actual_duration
            ) * 100
